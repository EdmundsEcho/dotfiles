   ...
   vim.g.rustaceanvim = {
      ...
      dap = {
         ...
         initCommands = function()
            logger.log("Setting up dap codelldb commands", vim.log.INFO)
      ...
      server = {
         ...
         on_attach = function(client, bufnr)
            logger.log("🔗 Attaching to " .. client.name, vim.log.INFO)
            handlers.on_attach(client, bufnr)

            local rt = require("rustaceanvim.nvim")
